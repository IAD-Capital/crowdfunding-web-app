          ...
          >
            <div style={imageWrap}>
              ...
              <div style={overlay}>
                ...
                <p style={overlayDevName}>{u.development_name} · {u.identifier}</p>
...
const overlayDevName: React.CSSProperties = { fontSize: "1.05rem", fontWeight: 700, color: "#fff", margin: 0, letterSpacing: "-0.01em" };
